<dialog id="edit_item_<?= $item['id'] ?>_modal" style="padding: 2rem; border-radius: 0.2rem;">
    <form method="POST" action="/handle_add_registry_item">
        ...
        <div class="field">
            ...
            <div class="control">
                <input maxlength="50" name="name" value="<?= $item['name'] ?>" class="input" type="text" placeholder="Item Name" required>
            </div>
        </div>
        ...
        <div class="field">
            ...
            <div class="control">
                <input maxlength="500" name="url" value="<?= $item['url'] ?>" class="input" type="text" placeholder="URL" required>
            </div>
        </div>
        ...
        <div class="field">
            ...
            <div class="control">
                <input maxlength="500" name="aff_url" value="<?= $item['affiliate_url'] ?>" class="input" type="text" placeholder="Affiliate URL">
            </div>
        </div>
        ...
        <div class="field">
            ...
            <div class="control">
                <input maxlength="500" name="img_url" value="<?= $item['image_url'] ?>" class="input" type="text" placeholder="Image URL" required>
            </div>
        </div>
